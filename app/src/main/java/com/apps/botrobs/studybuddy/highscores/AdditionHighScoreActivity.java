...
import com.apps.botrobs.studybuddy.BIquizCategories.MathCategoryAddition;
...
public class AdditionHighScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageHighscore.setImageResource(R.drawable.addition);

        TVcategoryname.setText("In this category, you will get Addition equations to be answered.");

        Intent intent = getIntent();
        int score = intent.getIntExtra("scoreAddition", 0);
        txtScore.setText("Your score: " + score);

        SharedPreferences mypref = getSharedPreferences("addition", 0);
        int highscore = mypref.getInt("additionHighscore", 0);
        ...
        if (highscore >= score){
            ...
            editor.putInt("additionHighscore", score);
            editor.commit();
        }
    }
    ...
    public void playAgain(View view) {
        startActivity(new Intent(this, MathCategoryAddition.class));
        finish();
    }
