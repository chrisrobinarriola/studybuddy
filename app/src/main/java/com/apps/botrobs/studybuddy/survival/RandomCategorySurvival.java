...
public class RandomCategorySurvival extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(RandomCategorySurvival.this);
        LayoutInflater inflater = LayoutInflater.from(RandomCategorySurvival.this);
    ...
    public void startTheGame(){
        mQuestionLibrary.initRandom(RandomCategorySurvival.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        if(mQuestionNumber <  50 ){
            ...
            mQuestionView.setText(mQuestionLibrary.getQuestionRandom(mQuestionNumber));
            mButtonChoice1.setText(mQuestionLibrary.getChoiceRandom(mQuestionNumber, 1));
            mButtonChoice2.setText(mQuestionLibrary.getChoiceRandom(mQuestionNumber, 2));
            mButtonChoice3.setText(mQuestionLibrary.getChoiceRandom(mQuestionNumber, 3));
            mButtonChoice4.setText(mQuestionLibrary.getChoiceRandom(mQuestionNumber,4));
            mAnswer = mQuestionLibrary.getCorrectAnswerRandom(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            Intent i = new Intent(RandomCategorySurvival.this, RandomHighScoreActivity.class);
            i.putExtra("scoreRandomS", mScore);
            i.putExtra("viewRandom", 0);
            startActivity(i);
            finish();
        }
    }
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(RandomCategorySurvival.this);
