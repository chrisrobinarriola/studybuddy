...
public class EnglishCategorySurvival extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(EnglishCategorySurvival.this);
        LayoutInflater inflater = LayoutInflater.from(EnglishCategorySurvival.this);
    ...
    public void startTheGame(){
        mQuestionLibrary.initEnglish(EnglishCategorySurvival.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        if(mQuestionNumber <  50 ){
            ...
            mQuestionView.setText(mQuestionLibrary.getQuestionEnglish(mQuestionNumber));
            mButtonChoice1.setText(mQuestionLibrary.getChoiceEnglish(mQuestionNumber, 1));
            mButtonChoice2.setText(mQuestionLibrary.getChoiceEnglish(mQuestionNumber, 2));
            mButtonChoice3.setText(mQuestionLibrary.getChoiceEnglish(mQuestionNumber, 3));
            mButtonChoice4.setText(mQuestionLibrary.getChoiceEnglish(mQuestionNumber,4));
            mAnswer = mQuestionLibrary.getCorrectAnswerEnglish(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            Intent i = new Intent(EnglishCategorySurvival.this, EnglishHighScoreActivity.class);
            i.putExtra("scoreEnglishS", mScore);
            i.putExtra("viewEnglish", 0);
            startActivity(i);
            finish();
        }
    }
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(EnglishCategorySurvival.this);
