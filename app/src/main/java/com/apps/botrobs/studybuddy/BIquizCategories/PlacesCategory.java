...
public class PlacesCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(PlacesCategory.this);
        LayoutInflater inflater = LayoutInflater.from(PlacesCategory.this);
        ...
        view.findViewById(R.id.TVexitRule).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PlacesCategory.this, ChooseNormalActivity.class));
                finish();
            }
        });
    }
    ...
    private void startTheGame() {
        mQuestionLibrary.initPlaces(PlacesCategory.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber <  10 ){
            ...
            Intent i = new Intent(PlacesCategory.this, PlacesHighScoreActivity.class);
            i.putExtra("scorePlaces",mScore);
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(PlacesCategory.this);
