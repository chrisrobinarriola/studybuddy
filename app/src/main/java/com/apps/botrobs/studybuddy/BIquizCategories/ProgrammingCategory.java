...
public class ProgrammingCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(ProgrammingCategory.this);
        LayoutInflater inflater = LayoutInflater.from(ProgrammingCategory.this);
        ...
        view.findViewById(R.id.TVexitRule).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ProgrammingCategory.this, ChooseNormalActivity.class));
                finish();
            }
        });
    }
    ...
    private void startTheGame() {
        mQuestionLibrary.initProgramming(ProgrammingCategory.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber <  10 ){
            ...
            Intent i = new Intent(ProgrammingCategory.this, ProgrammingHighScoreActivity.class);
            i.putExtra("scoreProgramming",mScore);
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(ProgrammingCategory.this);
