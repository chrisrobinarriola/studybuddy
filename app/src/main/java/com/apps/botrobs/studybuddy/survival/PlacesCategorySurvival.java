...
public class PlacesCategorySurvival extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(PlacesCategorySurvival.this);
        LayoutInflater inflater = LayoutInflater.from(PlacesCategorySurvival.this);
    ...
    public void startTheGame(){
        mQuestionLibrary.initPlaces(PlacesCategorySurvival.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        if(mQuestionNumber <  50 ){
            ...
            mQuestionView.setText(mQuestionLibrary.getQuestionPlaces(mQuestionNumber));
            mButtonChoice1.setText(mQuestionLibrary.getChoicePlaces(mQuestionNumber, 1));
            mButtonChoice2.setText(mQuestionLibrary.getChoicePlaces(mQuestionNumber, 2));
            mButtonChoice3.setText(mQuestionLibrary.getChoicePlaces(mQuestionNumber, 3));
            mButtonChoice4.setText(mQuestionLibrary.getChoicePlaces(mQuestionNumber,4));
            mAnswer = mQuestionLibrary.getCorrectAnswerPlaces(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            Intent i = new Intent(PlacesCategorySurvival.this, PlacesHighScoreActivity.class);
            i.putExtra("scorePlacesS", mScore);
            i.putExtra("viewPlaces", 0);
            startActivity(i);
            finish();
        }
    }
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(PlacesCategorySurvival.this);
