...
public class FilipinoCategorySurvival extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(FilipinoCategorySurvival.this);
        LayoutInflater inflater = LayoutInflater.from(FilipinoCategorySurvival.this);
    ...
    public void startTheGame(){
        mQuestionLibrary.initFilipino(FilipinoCategorySurvival.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        if(mQuestionNumber <  50 ){
            ...
            mQuestionView.setText(mQuestionLibrary.getQuestionFilipino(mQuestionNumber));
            mButtonChoice1.setText(mQuestionLibrary.getChoiceFilipino(mQuestionNumber, 1));
            mButtonChoice2.setText(mQuestionLibrary.getChoiceFilipino(mQuestionNumber, 2));
            mButtonChoice3.setText(mQuestionLibrary.getChoiceFilipino(mQuestionNumber, 3));
            mButtonChoice4.setText(mQuestionLibrary.getChoiceFilipino(mQuestionNumber,4));
            mAnswer = mQuestionLibrary.getCorrectAnswerFilipino(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            Intent i = new Intent(FilipinoCategorySurvival.this, FilipinoHighScoreActivity.class);
            i.putExtra("scoreFilipinoS", mScore);
            i.putExtra("viewFilipino", 0);
            startActivity(i);
            finish();
        }
    }
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(FilipinoCategorySurvival.this);
