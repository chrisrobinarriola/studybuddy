...
public class EnglishCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(EnglishCategory.this);
        LayoutInflater inflater = LayoutInflater.from(EnglishCategory.this);
        ...
        view.findViewById(R.id.TVexitRule).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(EnglishCategory.this, ChooseNormalActivity.class));
                finish();
            }
        });
    }
    public void startTheGame(){
        mQuestionLibrary.initEnglish(EnglishCategory.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber <  10 ){
            ...
            Intent i = new Intent(EnglishCategory.this, EnglishHighScoreActivity.class);
            i.putExtra("scoreEnglish",mScore);
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(EnglishCategory.this);
