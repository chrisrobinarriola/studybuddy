...
import com.apps.botrobs.studybuddy.BIquizCategories.MathCategorySubtraction;
import com.apps.botrobs.studybuddy.MainAppActivity;
import com.apps.botrobs.studybuddy.R;

public class SubtractionHighScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageHighscore.setImageResource(R.drawable.subtraction);

        TVcategoryname.setText("In this category, you will get Subtraction equations to be answered.");

        Intent intent = getIntent();
        int score = intent.getIntExtra("scoreSubtraction", 0);
        txtScore.setText("Your score: " + score);

        SharedPreferences mypref = getSharedPreferences("subtraction", 0);
        int highscore = mypref.getInt("subtractionHighscore", 0);
        ...
        if (highscore >= score){
            ...
            editor.putInt("subtractionHighscore", score);
            editor.commit();
        }
    }
    ...
    public void playAgain(View view) {
        startActivity(new Intent(this, MathCategorySubtraction.class));
        finish();
    }
