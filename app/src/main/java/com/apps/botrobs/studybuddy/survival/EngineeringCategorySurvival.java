...
public class EngineeringCategorySurvival extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(EngineeringCategorySurvival.this);
        LayoutInflater inflater = LayoutInflater.from(EngineeringCategorySurvival.this);
    ...
    public void startTheGame(){
        mQuestionLibrary.initEngineering(EngineeringCategorySurvival.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        if(mQuestionNumber <  50 ){
            ...
            mQuestionView.setText(mQuestionLibrary.getQuestionEngineering(mQuestionNumber));
            mButtonChoice1.setText(mQuestionLibrary.getChoiceEngineering(mQuestionNumber, 1));
            mButtonChoice2.setText(mQuestionLibrary.getChoiceEngineering(mQuestionNumber, 2));
            mButtonChoice3.setText(mQuestionLibrary.getChoiceEngineering(mQuestionNumber, 3));
            mButtonChoice4.setText(mQuestionLibrary.getChoiceEngineering(mQuestionNumber,4));
            mAnswer = mQuestionLibrary.getCorrectAnswerEngineering(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            Intent i = new Intent(EngineeringCategorySurvival.this, EngineeringHighScoreActivity.class);
            i.putExtra("scoreEngineeringS", mScore);
            i.putExtra("viewEngineering", 0);
            startActivity(i);
            finish();
        }
    }
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(EngineeringCategorySurvival.this);
