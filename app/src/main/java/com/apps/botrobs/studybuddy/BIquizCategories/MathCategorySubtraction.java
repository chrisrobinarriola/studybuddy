...
import com.apps.botrobs.studybuddy.highscores.SubtractionHighScoreActivity;

public class MathCategorySubtraction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(MathCategorySubtraction.this);
        LayoutInflater inflater = LayoutInflater.from(MathCategorySubtraction.this);
        ...
        view.findViewById(R.id.TVexitRule).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MathCategorySubtraction.this, MathCategory.class));
                finish();
            }
        });
    }
    ...
    public void startCount(){
        ...
        gameTimer = new CountDownTimer(mTimeLeftInMillis + 100, 1000) {
            ...
            public void onFinish() {
                gameIsActive = false;
                Intent i = new Intent(MathCategorySubtraction.this, SubtractionHighScoreActivity.class);
                i.putExtra("scoreSubtraction", score);
                startActivity(i);
                finish();
            }
        }.start();
    ...
    public void generateAnswer () {
        ...
        for (int i = 0; i <4; i++) {
            if (i == locOfAnswer) {
                ...
                wrongAnswer = rand.nextInt(a-b + 20);
    ...
    public void pauseTheGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(MathCategorySubtraction.this);
