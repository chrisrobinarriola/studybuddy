...
public class RandomCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(RandomCategory.this);
        LayoutInflater inflater = LayoutInflater.from(RandomCategory.this);
        ...
        view.findViewById(R.id.TVexitRule).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RandomCategory.this, ChooseNormalActivity.class));
                finish();
            }
        });
    }
    ...
    private void startTheGame() {
        mQuestionLibrary.initRandom(RandomCategory.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber <  10 ){
            ...
            Intent i = new Intent(RandomCategory.this, RandomHighScoreActivity.class);
            i.putExtra("scoreRandom",mScore);
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(RandomCategory.this);
