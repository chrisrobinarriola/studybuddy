...
public class EngineeringCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(EngineeringCategory.this);
        LayoutInflater inflater = LayoutInflater.from(EngineeringCategory.this);
        ...
        view.findViewById(R.id.TVexitRule).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(EngineeringCategory.this, ChooseNormalActivity.class));
                finish();
            }
        });
    }
    ...
    public void startTheGame(){
        mQuestionLibrary.initEngineering(EngineeringCategory.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber <  10 ){
            ...
            Intent i = new Intent(EngineeringCategory.this, EngineeringHighScoreActivity.class);
            i.putExtra("scoreEngineering",mScore);
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(EngineeringCategory.this);
