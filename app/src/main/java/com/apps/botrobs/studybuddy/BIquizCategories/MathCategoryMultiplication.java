...
import com.apps.botrobs.studybuddy.highscores.MultiplicationHighScoreActivity;

public class MathCategoryMultiplication extends AppCompatActivity {

    private static final String TAG = "MathCategorySubtraction";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(MathCategoryMultiplication.this);
        LayoutInflater inflater = LayoutInflater.from(MathCategoryMultiplication.this);
        ...
        view.findViewById(R.id.TVexitRule).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MathCategoryMultiplication.this, MathCategory.class));
                finish();
            }
        });
    }
    ...
    public void startCount(){
        ...
        gameTimer = new CountDownTimer(mTimeLeftInMillis + 100, 1000) {
            ...
            public void onFinish() {
                gameIsActive = false;
                Intent i = new Intent(MathCategoryMultiplication.this, MultiplicationHighScoreActivity.class);
                i.putExtra("scoreMultiplication", score);
                startActivity(i);
                finish();
            }
        }.start();
    ...
    public void generateAnswer () {
        ...
        promptTextView.setText(Integer.toString(a) + " x " + Integer.toString(b));
    ...
    public void pauseTheGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(MathCategoryMultiplication.this);
