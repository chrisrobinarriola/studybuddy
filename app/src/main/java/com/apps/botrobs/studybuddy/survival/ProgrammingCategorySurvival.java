...
public class ProgrammingCategorySurvival extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(ProgrammingCategorySurvival.this);
        LayoutInflater inflater = LayoutInflater.from(ProgrammingCategorySurvival.this);
    ...
    public void startTheGame(){
        mQuestionLibrary.initProgramming(ProgrammingCategorySurvival.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        if(mQuestionNumber <  50 ){
            ...
            mQuestionView.setText(mQuestionLibrary.getQuestionProgramming(mQuestionNumber));
            mButtonChoice1.setText(mQuestionLibrary.getChoiceProgramming(mQuestionNumber, 1));
            mButtonChoice2.setText(mQuestionLibrary.getChoiceProgramming(mQuestionNumber, 2));
            mButtonChoice3.setText(mQuestionLibrary.getChoiceProgramming(mQuestionNumber, 3));
            mButtonChoice4.setText(mQuestionLibrary.getChoiceProgramming(mQuestionNumber,4));
            mAnswer = mQuestionLibrary.getCorrectAnswerProgramming(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            Intent i = new Intent(ProgrammingCategorySurvival.this, ProgrammingHighScoreActivity.class);
            i.putExtra("scoreProgrammingS", mScore);
            i.putExtra("viewProgramming", 0);
            startActivity(i);
            finish();
        }
    }
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(ProgrammingCategorySurvival.this);
