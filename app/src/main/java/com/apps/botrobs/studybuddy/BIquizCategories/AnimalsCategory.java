...
public class AnimalsCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(AnimalsCategory.this);
        LayoutInflater inflater = LayoutInflater.from(AnimalsCategory.this);
        ...
        view.findViewById(R.id.TVexitRule).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AnimalsCategory.this, ChooseNormalActivity.class));
                finish();
            }
        });
    }
    ...
    public void startTheGame(){
        mQuestionLibrary.initAnimals(AnimalsCategory.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        if(mQuestionNumber <  10 ){
            ...
            Intent i = new Intent(AnimalsCategory.this, AnimalsHighScoreActivity.class);
            i.putExtra("scoreAnimals",mScore);
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(AnimalsCategory.this);
