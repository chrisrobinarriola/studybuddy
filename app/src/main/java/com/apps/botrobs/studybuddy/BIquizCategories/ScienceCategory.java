...
public class ScienceCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(ScienceCategory.this);
        LayoutInflater inflater = LayoutInflater.from(ScienceCategory.this);
        ...
        view.findViewById(R.id.TVexitRule).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ScienceCategory.this, ChooseNormalActivity.class));
                finish();
            }
        });
    }
    ...
    private void startTheGame() {
        mQuestionLibrary.initScience(ScienceCategory.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber <  10 ){
            ...
            Intent i = new Intent(ScienceCategory.this, ScienceHighScoreActivity.class);
            i.putExtra("scoreScience",mScore);
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(ScienceCategory.this);
