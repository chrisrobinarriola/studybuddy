...
public class AnimalsCategorySurvival extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(AnimalsCategorySurvival.this);
        LayoutInflater inflater = LayoutInflater.from(AnimalsCategorySurvival.this);
    ...
    public void startTheGame(){
        mQuestionLibrary.initAnimals(AnimalsCategorySurvival.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        if(mQuestionNumber <  50 ){
            ...
            mQuestionView.setText(mQuestionLibrary.getQuestionAnimals(mQuestionNumber));
            mButtonChoice1.setText(mQuestionLibrary.getChoiceAnimals(mQuestionNumber, 1));
            mButtonChoice2.setText(mQuestionLibrary.getChoiceAnimals(mQuestionNumber, 2));
            mButtonChoice3.setText(mQuestionLibrary.getChoiceAnimals(mQuestionNumber, 3));
            mButtonChoice4.setText(mQuestionLibrary.getChoiceAnimals(mQuestionNumber,4));
            mAnswer = mQuestionLibrary.getCorrectAnswerAnimals(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            Intent i = new Intent(AnimalsCategorySurvival.this, AnimalsHighScoreActivity.class);
            i.putExtra("scoreAnimalsS", mScore);
            i.putExtra("viewAnimals", 0);
            startActivity(i);
            finish();
        }
    }
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(AnimalsCategorySurvival.this);
