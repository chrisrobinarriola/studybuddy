...
public class FilipinoCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(FilipinoCategory.this);
        LayoutInflater inflater = LayoutInflater.from(FilipinoCategory.this);
        ...
        view.findViewById(R.id.TVexitRule).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FilipinoCategory.this, ChooseNormalActivity.class));
                finish();
            }
        });
    }
    ...
    private void startTheGame() {
        mQuestionLibrary.initFilipino(FilipinoCategory.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber <  10 ){
            ...
            Intent i = new Intent(FilipinoCategory.this, FilipinoHighScoreActivity.class);
            i.putExtra("scoreFilipino",mScore);
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(FilipinoCategory.this);
