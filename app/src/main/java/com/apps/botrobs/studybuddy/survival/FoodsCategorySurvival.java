...
public class FoodsCategorySurvival extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(FoodsCategorySurvival.this);
        LayoutInflater inflater = LayoutInflater.from(FoodsCategorySurvival.this);
    ...
    public void startTheGame(){
        mQuestionLibrary.initFoods(FoodsCategorySurvival.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        if(mQuestionNumber <  50 ){
            ...
            mQuestionView.setText(mQuestionLibrary.getQuestionFoods(mQuestionNumber));
            mButtonChoice1.setText(mQuestionLibrary.getChoiceFoods(mQuestionNumber, 1));
            mButtonChoice2.setText(mQuestionLibrary.getChoiceFoods(mQuestionNumber, 2));
            mButtonChoice3.setText(mQuestionLibrary.getChoiceFoods(mQuestionNumber, 3));
            mButtonChoice4.setText(mQuestionLibrary.getChoiceFoods(mQuestionNumber,4));
            mAnswer = mQuestionLibrary.getCorrectAnswerFoods(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            Intent i = new Intent(FoodsCategorySurvival.this, FoodsHighScoreActivity.class);
            i.putExtra("scoreFoodsS", mScore);
            i.putExtra("viewFoods", 0);
            startActivity(i);
            finish();
        }
    }
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(FoodsCategorySurvival.this);
