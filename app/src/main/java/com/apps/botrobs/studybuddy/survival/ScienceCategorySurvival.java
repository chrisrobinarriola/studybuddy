...
public class ScienceCategorySurvival extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(ScienceCategorySurvival.this);
        LayoutInflater inflater = LayoutInflater.from(ScienceCategorySurvival.this);
    ...
    public void startTheGame(){
        mQuestionLibrary.initScience(ScienceCategorySurvival.this);
        updateQuestion();
        updateScore(mScore);
        startCount();
    }
    ...
    private void updateQuestion(){
        if(mQuestionNumber <  50 ){
            ...
            mQuestionView.setText(mQuestionLibrary.getQuestionScience(mQuestionNumber));
            mButtonChoice1.setText(mQuestionLibrary.getChoiceScience(mQuestionNumber, 1));
            mButtonChoice2.setText(mQuestionLibrary.getChoiceScience(mQuestionNumber, 2));
            mButtonChoice3.setText(mQuestionLibrary.getChoiceScience(mQuestionNumber, 3));
            mButtonChoice4.setText(mQuestionLibrary.getChoiceScience(mQuestionNumber,4));
            mAnswer = mQuestionLibrary.getCorrectAnswerScience(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            Intent i = new Intent(ScienceCategorySurvival.this, ScienceHighScoreActivity.class);
            i.putExtra("scoreScienceS", mScore);
            i.putExtra("viewScience", 0);
            startActivity(i);
            finish();
        }
    }
    ...
    public void pauseGame(){
        ...
        if (timerRunning) {
            ...
            view.findViewById(R.id.TVretry).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    AlertDialog.Builder builder1= new AlertDialog.Builder(ScienceCategorySurvival.this);
